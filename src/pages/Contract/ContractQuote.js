import { Avatar, Box, Flex, HStack, Spacer, Table, Tbody, Td, Text, Tr, useDisclosure, WrapItem } from '@chakra-ui/react';
import React, { useState } from 'react'
import { FaEye } from 'react-icons/fa';
import { IoIosArrowBack, IoIosArrowForward } from 'react-icons/io';
import Select from '../../components/Select';
import Option from '../rfq/Components/Option';
import CompareModal from '../rfq/RfqModals/CompareModal';
...
function ContractQuote() {
  ...
  return (
      <>
          ...
          {singleQuote ? (
              <Quote onClick={() => setSingleQuote(!singleQuote)} />
          ) : (
              <>
                  <Flex flexWrap={'wrap'}>
